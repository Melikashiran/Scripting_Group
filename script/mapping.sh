...
WD=/home/aubclse0046/mmutica           ## Example:/scratch/$MyID/PracticeRNAseq  
CD=/scratch/germlineexplorer/cryptodira/mauremys_mutica/CleanData             ## Example:/scratch/$MyID/PracticeRNAseq/CleanData   #   *** This is where the cleaned paired files are located from the last script
REFD=/scratch/germlineexplorer/cryptodira/mauremys_mutica/reference          ## Example:/scratch/$MyID/PracticeRNAseq/DaphniaRefGenome    # this directory contains the indexed reference genome for the garter snake
MAPD=/scratch/germlineexplorer/cryptodira/mauremys_mutica/Map_HiSat2           ## Example:/scratch/$MyID/PracticeRNAseq/Map_HiSat2      #
COUNTSD=/scratch/germlineexplorer/cryptodira/mauremys_mutica/Counts_StringTie       ## Example:/scratch/$MyID/PracticeRNAseq/Counts_StringTie
RESULTSD=/home/aubclse0046/mmutica/Counts_mmutica     ## Example:/home/aubtss/PracticeRNAseq/Counts_H_S

REF=GCF_020497125.1_ASM2049712v1_genomic                 ## This is what the "easy name" will be for the genome reference
...
# cp /scratch/germlineexplorer/cryptodira/mauremys_mutica/reference/${REF}.fna .
# cp /scratch/germlineexplorer/cryptodira/mauremys_mutica/reference/${REF}.gff .
...
hisat2-build --ss ${REF}.ss --exon ${REF}.exon ${REF}.fasta mmutica_index
...
cp /home/aubclse0046/Germline-Explorer/scripts/03b_prepDE.py3 .
